export const MJEKESIA_LIGJORE_1 = {
  ...
  questions: [
    ...
    },
    {
      ...
      explanation: "Ekspertimi mjekoligjor i kufomave kërkohet në të gjitha rastet e vdekjeve të dyshimta ose të dhunshme për të përcaktuar shkakun dhe mënyrën e vdekjes.",
      correct: 2,
    },
    {
      ...
      explanation: "Eksperti mjekoligjor ka për detyrë të mbledhë prova materiale dhe të kryejë autopsinë për të ndihmuar në zbardhjen e rrethanave të krimit.",
      correct: 1,
    },
    {
      ...
      explanation: "Hetimi mjekoligjor përfshin këqyrjen e kufomave, personave të gjallë dhe provave materiale biologjike për të zbuluar të vërtetën në një hetim.",
      correct: 2,
    },
    {
      ...
      explanation: "Ekspertët mjekoligjorë nuk marrin vendime përfundimtare, por japin mendime profesionale që vlerësohen nga gjykata.",
      correct: 2,
    },
    {
      ...
      alternatives: [
        ...
        "Vetëm në rastet e përcaktimit të moshës", 
        "Në rastet e përcaktimit të dëmtimeve trupore, krimeve seksuale dhe identitetit", 
        "Vetëm në rastet e përcaktimit të atësisë."
      ],
      explanation: "Hetimi i personave të gjallë nga mjekësia ligjore kërkohet në rastet e përcaktimit të dëmtimeve trupore, krimeve seksuale dhe identitetit për të siguruar prova dhe fakte.",
      correct: 2,
    },
    {
      ...
      explanation: "Ekspertët mjekoligjorë këqyrin vendin e ngjarjes për të mbledhur prova materiale dhe për të dokumentuar gjendjen e vendit, duke ndihmuar në hetimin e krimit.",
      correct: 1,
    },
    {
      ...
      explanation: "Mjekësia ligjore nuk përcakton fajësinë e të pandehurit, por ndihmon në zbardhjen e fakteve dhe provave që lidhen me shkakun dhe mënyrën e vdekjes.",
      correct: 1,
    },
    {
      ...
      explanation: "Eksperti mjekoligjor mbledh të dhëna dhe prova për të ndihmuar në identifikimin e kufomave, duke përdorur metoda shkencore dhe teknika të specializuara.",
      correct: 1,
    },
    {
